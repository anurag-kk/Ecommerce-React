...
const Sidebar = () => {
  ...
  bg-white fixed top-0 h-full shadow-2xl md:w-[35vw] xl:max-w-[30vw] 
  transition-all duration-300 z-20 px-4 lg:px-[35px]`}>
    ...
    <div className='flex flex-col gap-y-2 max-h-[320px] lg:max-h-[400px] overflow-y-auto overflow-x-hidden border-b'>
      {cart.map((item) => {
      return (
    ...
    <div className='flex flex-col gap-y-2 mt-4 border-2'>
      <div className='flex w-full justify-between items-center'>
        <div className='uppercase font-semibold pl-4'><span className='mr-2'>Total:</span>$ {parseFloat(total).toFixed(2)}</div>
